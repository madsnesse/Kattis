""" This file is a rewrite of the file found at https://open.kattis.com/help/submit, this was to allow sending in username and token from command line to run it from github actions """
...
Overrides default guess (based on suffix of first filename)''')
    ...
    parser.add_argument('-k', '--token',
                        help='the users token')
    parser.add_argument('files', nargs='+')

    args = parser.parse_args()
    files = args.files

    cfg = {"username": args.username, "token": args.token, "submissionurl": "https://open.kattis.com/submit", "loginurl": "https://open.kattis.com/login"}
